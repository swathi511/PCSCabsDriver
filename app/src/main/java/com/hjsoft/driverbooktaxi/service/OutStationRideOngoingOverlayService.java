 ...
 */
public class OutStationRideOngoingOverlayService extends Service implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        it.setComponent(new ComponentName(getApplicationContext().getPackageName(), RideOngoingOutstation.class.getName()));
