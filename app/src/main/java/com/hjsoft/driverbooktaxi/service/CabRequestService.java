...
/**
 * Created by hjsoft on 19/3/18.
 */
public class CabRequestService extends Service {

    public static final String ACTION = "com.hjsoft.driverbooktaxi.service.cabrequestservice";
    API REST_CLIENT;
    Handler handler;
    Runnable r;
    ...
    public void onCreate() {
        ...
        //System.out.println("Srevice onCreate called!!!!");
        ...
        //System.out.println("profileid in srevice is "+stProfileId);
    ...
    SubscribeCallback subscribeCallback=new SubscribeCallback()  {
        ...
        public void status(PubNub pubnub, PNStatus status) {
            /*switch (status.getOperation()) {
                ...
                case PNUnsubscribeOperation:
                    ...
                    System.out.println("CRS*******"+status.getCategory());

                    //Loggly.i("CabRequestService",stProfileId+" subscribe status "+status.getCategory());
        ...
        public void message(PubNub pubnub, PNMessageResult message) {
            ...
            Loggly.i("CabRequestService",stProfileId+" "+msg);

            //System.out.println("data "+msg.getAsString());
        ...
        public void presence(PubNub pubnub, PNPresenceEventResult presence) {
            ...
            System.out.println("CRS presence "+presence);
