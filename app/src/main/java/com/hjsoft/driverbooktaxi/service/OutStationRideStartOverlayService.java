 ...
 */
public class OutStationRideStartOverlayService extends Service implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        it.setComponent(new ComponentName(getApplicationContext().getPackageName(), RideOutstation.class.getName()));
