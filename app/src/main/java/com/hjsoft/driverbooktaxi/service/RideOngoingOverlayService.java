...
/**
 * Created by hjsoft on 10/2/17.
 */
public class RideOngoingOverlayService extends Service implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        it.setComponent(new ComponentName(getApplicationContext().getPackageName(), RideOngoingLocal.class.getName()));
