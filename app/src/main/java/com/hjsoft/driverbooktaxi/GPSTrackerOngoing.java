 ...
 */
public class GPSTrackerOngoing extends Service implements LocationListener {
    ...
    public GPSTrackerOngoing(Context context) {
    ...
    public void stopUsingGPS(){
        try {
            if (locationManager != null) {
                locationManager.removeUpdates(GPSTrackerOngoing.this);
            }
        }
