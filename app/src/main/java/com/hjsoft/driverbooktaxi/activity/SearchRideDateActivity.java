...
import com.hjsoft.driverbooktaxi.fragments.SearchRideDateFragment;
 ...
 */
public class SearchRideDateActivity extends AppCompatActivity implements SearchRideRecyclerAdapter.AdapterCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        System.out.println("in search ride activity");
        ...
        Fragment fragment=new SearchRideDateFragment();
    ...
    private void selectItem(int position) {
        ...
        switch (position) {
            case 0:
                Intent i=new Intent(SearchRideDateActivity.this,HomeActivity.class);
                startActivity(i);
                finish();
                break;
            case 1:
                Intent j=new Intent(SearchRideDateActivity.this,SearchRideDateActivity.class);
                startActivity(j);
                finish();
                break;
            case 2:
            ...
            else
            {
                if(item.getTravelType().equals("local")||item.getTravelType().equals("Packages")) {
                    ...
                    if(dataList.size()==0)
                    {
                        ...
                        {
                            Toast.makeText(SearchRideDateActivity.this, "Please wait...", Toast.LENGTH_LONG).show();
                            ...
                            Intent i = new Intent(SearchRideDateActivity.this, RideLocal.class);
                            ...
                            Intent i = new Intent(SearchRideDateActivity.this, TrackRideActivity.class);
                            i.putExtra("cabData", cabData);
                            startActivity(i);
                            finish();
                        }
                        ...
                        Intent i = new Intent(SearchRideDateActivity.this, RideOngoingLocal.class);
                ...
                else
                {
                    ...
                    if(dataList.size()==0)
                    {
                        if(item.getOtpStatus().equals("1"))
                        {
                            ...
                            Intent i = new Intent(SearchRideDateActivity.this, RideOutstation.class);
                            i.putExtra("cabData", cabData);
                            startActivity(i);
                            finish();
                        }
                            ...
                            Intent i = new Intent(SearchRideDateActivity.this, OutStationTrackRideActivity.class);
                            i.putExtra("cabData", cabData);
                            startActivity(i);
                            finish();
                        }
                        ...
                        Intent i = new Intent(SearchRideDateActivity.this,RideOngoingOutstation.class);
                        i.putExtra("list", data);
                        i.putExtra("position", position);
                        startActivity(i);
                        finish();
    ...
    {
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(SearchRideDateActivity.this);
