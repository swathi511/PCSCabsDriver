 ...
 */
public class BookingHistoryActivity  extends AppCompatActivity implements BookingHistoryRecyclerAdapter.AdapterCallback {
    ...
    private void selectItem(int position) {
        ...
        switch (position) {
            case 0:
                Intent i=new Intent(BookingHistoryActivity.this,HomeActivity.class);
                startActivity(i);
                finish();
                break;
            case 1:
                Intent j=new Intent(BookingHistoryActivity.this,BookingHistoryActivity.class);
                startActivity(j);
                finish();
                break;
            case 2:
    ...
    @Override
    public void onMethodCallback(int position, ArrayList<BookingHistoryData> data) {

        BookingHistoryData d;

        d=data.get(position);

        Intent i=new Intent(BookingHistoryActivity.this,AllRidesActivity.class);
        i.putExtra("dateValue",d.getDate());
        startActivity(i);
        //finish();
    }
    ...
    {
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(BookingHistoryActivity.this);
